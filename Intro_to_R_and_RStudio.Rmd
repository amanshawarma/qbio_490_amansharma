...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/amansharma/Desktop/QBIO490/qbio_490_amansharma")) 
```
...
age <- 21
birthday <- "10/06/2002"
three_fav_colors <- c("blue", "sea green", "crimson")
print(paste("Name:", name))
print(paste("Age:", age))
print(paste("Birthday:", birthday))
print(paste("Three favorite colors:", three_fav_colors))
